...
main
  ...
  .game-banner
    ...
    .banner-box
      ...
      padding-block: 50px
      margin: 0 auto
      background: url('@/assets/images/game-banner.png') no-repeat center center / 100% 100%
      ...
      .banner-text
        ...
        h2
          ...
          span
            display: inline-block
            background: rgba(35,161,149,100)
            color: #100f13
            padding-inline: 10px
        p
          margin-top: 35px
  ...
  .game-home-bg
    ...
    .game-home-content
      width: 100%
      padding: 0
      .game-home-content-tit
        font-size: 24px
        font-weight: 700
        margin-bottom: 22px
      .game-home-content-list
        display: grid
        grid-template-columns: repeat(3, 1fr)
        gap: 20px
        @media (max-width: 768px)
          grid-template-columns: repeat(1, 1fr)
        .game-home-content-list-items
          background: #fff
      ...
      .currency-list
        ...
        .currency-item
          ...
          align-items: center
          background: #fff
          grid-template-columns: 1fr 18% 18% 25%
          padding: 18px 24px
