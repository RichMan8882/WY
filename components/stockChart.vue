...
const chartSetting = () => {
  console.log('......start chartSetting......', options.value)
  // 圖表設定
  const chartInit = init(chartContainer.value, options.value)
...
<template>
  <div id="container" class="container">
    <div class="chartSection">
      ...
      <div ref="chartContainer" id="k-line-chart" class="chartStyle">
        <button
          ref="backBtn"
          type="button"
          class="backBtn"
