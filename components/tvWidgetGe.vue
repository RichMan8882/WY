<template>
  <div>
    <div class="right-widget">
      <div class="item">
        <div class="cover" @click="navigateTo('/game')"></div>
      ...
      <div class="item">
        ...
        <!-- <a href="#0" target="_blank" class="auth"></a> -->
        <!-- TradingView Widget BEGIN -->
        <div id="widget_4" ref="widget4" class="tradingview-widget-container">
          <div class="tradingview-widget-container__widget"></div>
        </div>
        <!-- TradingView Widget END -->
      </div>
      <div class="item">
        ...
        <!-- <a href="#0" target="_blank" class="auth"></a> -->
        <!-- TradingView Widget BEGIN -->
        <div id="widget_5" ref="widget5" class="tradingview-widget-container">
          <div class="tradingview-widget-container__widget"></div>
        </div>
        <!-- TradingView Widget END -->
      </div>
      <div class="item">
        ...
        <!-- <a href="#0" target="_blank" class="auth"></a> -->
        <!-- TradingView Widget BEGIN -->
        <div id="widget_6" ref="widget6" class="tradingview-widget-container">
          <div class="tradingview-widget-container__widget"></div>
        </div>
        <!-- TradingView Widget END -->
      </div>
...
export default {
  ...
  methods: {
    ...
    loadWidgets() {
      this.loadWidget('widget1', 'OANDA:GBPUSD')
      this.loadWidget('widget2', 'FX:EURUSD')
      this.loadWidget('widget3', 'FX_IDC:USDAUD')
      this.loadWidget('widget4', 'BITSTAMP:ETHUSD')
      this.loadWidget('widget5', 'BITSTAMP:BTCUSD')
      this.loadWidget('widget6', 'FX_IDC:USDCAD')
